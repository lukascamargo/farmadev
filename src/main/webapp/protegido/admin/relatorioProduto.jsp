                        ...
                        <div class="form-group">
                            <div class="form-row border ">
                                <div class="form-group col-md-5px">
                                    ...
                                    <input type="date"  class="form-control"  name="dataini" placeholder="ano-mes-dia" required value="2020-06-01" />
                                </div>
                                <div class="form-group col-md-5px">
                                    <label> Data fim: </label>
                                    <input type="date"  class="form-control"  name="datafim"  placeholder="ano-mes-dia" required  value="2020-07-31" />
                                </div>
                            </div>
                            <div class="form-row border ">
                                <div class="form-group col-md-5px">
